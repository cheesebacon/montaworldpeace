...
export default function Personal() {
  const posts = allPosts.filter(p => p.category === "Personal");

  return (
    <div className="personal-page">
      <div style={{ padding: '20px 0', marginBottom: '30px', borderBottom: '2px dashed var(--color-orange)' }}>
        <h2 style={{ color: 'var(--color-purple-retro)', fontSize: '2.5rem', margin: 0 }}>Personal Blog</h2>
        <p style={{ fontSize: '1.1rem', opacity: 0.8, marginTop: '10px' }}>
          Stuff that doesn't exactly qualify elsewhere.
        </p>
      </div>
